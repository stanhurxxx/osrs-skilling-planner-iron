...
public class SlayerTasksTitleComboBox extends JComboBox<SlayerTasksTitleComboBox.Model> {
    private SlayerView view;
    
    private boolean isMenuOpen = false;

    public SlayerTasksTitleComboBox(SlayerView view) {
        super();  // Call to superclass constructor
        this.view = view;
        SlayerTasksTitleComboBox comboBox = this;
