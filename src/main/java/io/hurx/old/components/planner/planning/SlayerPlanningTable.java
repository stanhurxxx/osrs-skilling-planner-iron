...
import io.hurx.components.textField.abbreviatedNumberFormattedTextField.AbbreviatedNumberFormattedTextFieldCellEditor;
...
public class SlayerPlanningTable extends DefaultTable {
    ...
    public SlayerPlanningTable(SlayerView view, String uuid) {
        ...
        SlayerPlanningData planning = Cache.getRepository().getSlayer().findPlanningByFileName(uuid);
